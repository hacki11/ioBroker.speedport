...
describe("Smart3 => decrypt", () => {
    const sp = new Smart3("http://host", "dummy");

    it(`should decrypt the login no.1 (get challenge) request correctly`, () => {
    ...
    it(`should decrypt the login no.2 (send password) request correctly`, () => {
    ...
    it(`should decrypt the login no.3 (get next challenge #2) correctly`, () => {
    ...
    it(`should decrypt the login no.4 (send password, second attempt) request correctly`, () => {
...
describe("Smart3 => encrypt", () => {
    const sp = new Smart3("http://host", "dummy");

    it(`should encrypt the login request correctly`, () => {
        const challenge = "C9EAEB1CCA2FBB6DE0C3BC0965E3FBBC883BAD8B430CB499791EFC69BCA1D59C";
    ...
    it(`should encrypt the challenge request correctly`, () => {
...
describe("Smart3 => getChallenge", () => {

    const sp = new Smart3("http://host", "dummy");
    const httoken = "2022817050";

    it(`should send encrypted challenge request, decrypt response and extract challenge #1`, async () => {
    ...
    it(`should extract challenge #2 correctly`, async () => {
        const sp = new Smart3("http://host", "dummy");
...
describe("Smart3 => getHttoken", () => {

    it(`should extract httoken`, async () => {
        ...
        return sputils.getHttoken("host")
            .then(actual => expect(actual).to.be.equal(expected));
    });
    mock.reset();
});

describe("Smart3 => sendLogin", () => {
    const sp = new Smart3("http://host", "dummy");
    ...
    it(`should send encrypted login request and validates response`, async () => {
