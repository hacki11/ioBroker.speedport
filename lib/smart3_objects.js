...
function initINetIP() {
    ...
    value(objects, "WAN.ipv4_dns_pri", "WAN IPv4 Primary DNS Server", "string", "", d => parse("value", "dns_v4", d));
    value(objects, "WAN.ipv4_dns_sec", "WAN IPv4 Secondary DNS Server", "string", "", d => parse("value", "sec_dns_v4", d));
    ...
    value(objects, "WAN.ipv6_dns_pri", "WAN IPv6 Primary DNS Server", "string", "", d => parse("value", "dns_v6", d));
    value(objects, "WAN.ipv6_dns_sec", "WAN IPv6 Secondary DNS Server", "string", "", d => parse("value", "sec_dns_v6", d));
